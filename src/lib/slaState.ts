// Phase 5 - WhatsApp handoff SLA. Frontend MIRROR of
// supabase/functions/_shared/inbox/slaState.ts (the server file + the
// sla_sweep() SQL are the source of truth; this drives the Conversation
// detail SLA badge, the Inbox list "Overdue" badge and Needs Attention).
// No I/O. Keep in lockstep with the server file.
